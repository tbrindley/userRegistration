...
<html>
<head>
    <title>Travis Brindley - Add User</title>
...
<div class="container">
    ...
    <ul class="nav nav-pills">
        ...
        <li role="presentation" class="active"><a href="/newuser">Add user</a></li>
    </ul>
    <form name="adduser" action="addUser" onsubmit="return validateCreateUser()" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="address2" maxlength="60">
        </div>
        <div class="form-group">
            <label>City:</label>
        ...
        <div class="form-group">
            <label>Zip:</label>
            <input type="text" class="form-control" name="zip" maxlength="10" required> <br>
        </div>
